...
class Order (SafeDeleteModel):
    ...
    vendors = models.ForeignKey(Vendor, to_field="vendor_uid",
...
class OrderProduct(SafeDeleteModel):
    ...
    product = models.ForeignKey(Product,to_field="product_uid",
                                db_column="product_uid",
                                related_name='products',on_delete=models.DO_NOTHING)
    order = models.ForeignKey(Order,to_field="order_uid",
                              db_column="order_uid",
                              related_name='order_products',on_delete=models.CASCADE, null=True)
